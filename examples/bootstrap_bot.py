...
class BootstrapBot(KikClientCallback):
    """
    A Kik bot that can be bootstrapped for Docker.
    This class is literally the same as EchoBot, but we're using
    a __slots__ field definition array, and we've removed the constructor.
    """
