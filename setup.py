...
setup(
    ...
    install_requires=['pbkdf2', 'rsa', 'lxml', 'bs4', 'protobuf>=4.21.0', 'requests', 'pillow', 'pyDes', 
                    'python-dotenv', "PyYAML~=6.0.1", "defusedxml~=0.7.1", "lxml~=4.9.3", "beautifulsoup4~=4.12.2", "colorama"],
