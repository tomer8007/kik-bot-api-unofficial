...
# note that a kik version that's not updated might cause a captcha on login
...
kik_version_info = kik_version_14_5_info          # upgrading to later versions might trigger SafetyNet problems
