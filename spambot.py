...
class EchoBot(KikClientCallback):
    ...
    def on_chat_message_received(self, chat_message: chatting.IncomingChatMessage):
        ...
        # disconnect the bot incase it gets removed from a chat but doesn't stop spamming
        elif chat_message.body.lower() == 'disconnect':
            self.client.send_chat_message(chat_message.from_jid, 'Turning the bot off..')
